...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ptychodus-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ptychodus-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ptychodus ptychodus-all ptychodus-core
# for installing globally
pixi global install ptychodus ptychodus-all ptychodus-core
```
...
It is possible to list all of the versions of `ptychodus` available on your platform:
...
```
pixi search ptychodus --channel conda-forge
```
